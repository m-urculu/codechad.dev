...
export const MODULE_META: Record<string, ModuleMeta> = {
  ...
  csharp: { id: "csharp", title: "C# / .NET", goals: ["Apps & games (Unity)", "Web (ASP.NET)", "Just the language"] },
  ...
  node: { id: "node", title: "Node.js", goals: ["APIs & servers", "Tooling & CLIs", "Full-stack"] },
  ...
  linux: { id: "linux", title: "Linux / Bash", goals: ["CLI fluency", "DevOps basics", "Servers"] },
