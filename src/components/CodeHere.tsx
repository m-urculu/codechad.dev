        ...
        <div className="h-full w-full min-w-0">
          <div className="h-full font-mono font-normal leading-normal bg-neutral-900 rounded-[20px] border border-white/10 backdrop-blur-md flex flex-col gap-0 overflow-hidden">
            ...
            <div className="flex-1 flex flex-col">
              <div className="h-full p-4 bg-black/80 border border-white/10 text-green-400 text-xs font-mono overflow-auto custom-scrollbar shadow-inner rounded-b-[20px] rounded-t-none">
