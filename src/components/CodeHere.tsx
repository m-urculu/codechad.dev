...
export default function CodeHere() {
  return (
  <div className="w-full h-full font-mono font-normal leading-normal bg-neutral-900 rounded-[20px] border border-white/10 backdrop-blur-md flex flex-col gap-0 overflow-hidden">
      ...
      <div className="flex items-center justify-start gap-3 py-1 border-t border-white/10">
        <div className="flex items-center justify-start gap-3 py-1 ml-4">
          <button className="px-2 py-1 rounded-full bg-neutral-600 hover:bg-neutral-300 text-neutral-900 font-semibold text-xs font-thin transition-colors cursor-pointer flex items-center gap-2">
      ...
      <div className="flex-1 flex flex-col">
        <div className="w-full h-full p-4 bg-black/80 border border-white/10 text-green-400 text-xs font-mono overflow-auto custom-scrollbar shadow-inner rounded-b-[20px] rounded-t-none">
